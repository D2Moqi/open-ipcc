/**
 * 自定义双锚点矩形节点模型 右侧只能有一个右连接线
 * 继承自 HtmlNodeModel，节点尺寸由 Vue 组件 HTML 内容自动撑开
 * 用于 IVR 流程设计中的放音、收号、转接、方法调用等节点
 * 特点：左侧锚点不可作为连线起点，只能作为终点；右侧锚点仅允许连出一条边
 */
import { HtmlNodeModel } from '@logicflow/core'

class CustomBilRightOne extends HtmlNodeModel {
...
export default CustomBilRightOne
