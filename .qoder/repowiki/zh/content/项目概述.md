...
## 更新摘要
**变更内容**
- README.md进行了简化处理，移除了特定分支名称（master-jdk25-cc / master-jdk17-cc）的引用，使开发工具指导更加通用化
- 更新了开发环境配置说明，强调JDK 25的必要性
- 完善了多模块项目的子模块管理说明
- 保持了核心功能和技术架构的完整性
...
**更新** 开发工具指导已简化，移除了特定分支名称引用，使配置更加通用化
...
**更新** 开发工具指导已简化，移除了特定分支名称引用，使配置更加通用化和易于理解
