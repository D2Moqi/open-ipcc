...
import cn.iocoder.yudao.module.ai.controller.admin.model.vo.chatRole.AiChatRoleSimpleRespVO;
...
public class AiChatRoleController {
    ...
    @Operation(summary = "获得公开可选的聊天角色精简列表（供 IVR 设计器等公共场景）")
    public CommonResult<List<AiChatRoleSimpleRespVO>> getChatRoleSimpleList() {
        List<AiChatRoleDO> roles = chatRoleService.getChatRoleSimpleList();
        return success(BeanUtils.toBean(roles, AiChatRoleSimpleRespVO.class));
    }
